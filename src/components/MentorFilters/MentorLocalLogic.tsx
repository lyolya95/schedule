...
import {TableScheduleContainer} from "../TableSchedule/TableScheduleContainer";

export const MentorFilters: FC = (props: any) => {
    ...
    return (
        <>
            ...
            <TableScheduleContainer visibleData={visibleData} {...props}/>
        </>
    )
