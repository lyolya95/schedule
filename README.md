...
- **Создание концепта приложения +30**
  ...
  - [x] идеи по улучшению расписания представлены в виде списка конкретных изменений и усовершенствований, которые необходимо внести в приложение +10
    ...
    - студенты могут поставить рейтинг событию в виде 5 звезд, ведется подсчет среднего значения рейтинга. Ментор имеет возможность просмотреть рейтинги к событиям
    - добавлены фильтры для отбора событий по курсу, типу, диапазону дат, месту проведения, организатору
...
** - данные пункты не реализованы, команда решила, что одновременная правка в таблице и просмотр на календаре и в списке делает приложение менее удобным, непонятным и приведет к ухудшению юзабилити приложения.
...
- **Оптимизация расписания +110**
  ...
  - [x] в расписание внесены дополнительные не указанные в задании полезные усовершенствования, которые облегчают работу с ним, делают его более удобным и функциональным, улучшают внешний вид и т.д. +10 баллов за каждое полезное качественно выполненное усовершенствование\*, но не более 80 баллов
    ...
    - [x] студенты могут поставить рейтинг событию в виде 5 звезд, ведется подсчет среднего значения рейтинга. После выбора рейтинга, форма становится недоступной для изменения и выводится среднее значение рейтинга.(Для демонстрирования возможности накопления рейтинга и пересчета среднего, каждый раз при заходе на страницу студент считается не голосовавшим.). Ментор имеет возможность просмотреть рейтинги к событиям +10
